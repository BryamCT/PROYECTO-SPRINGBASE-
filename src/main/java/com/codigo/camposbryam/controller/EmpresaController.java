package com.codigo.camposbryam.controller;


import com.codigo.camposbryam.entity.EmpresaEntity;
import com.codigo.camposbryam.service.EmpresaService;
...
public class EmpresaController {
    ...
    @Operation(summary = "Crear una nueva Empresa",
            description = "Para usar endPoint debes enviar un objeto Empresa, lo cual se va a guardar en base de datos previa validacion")
    @ApiResponses(value = {
    ...
    @Operation(summary = "buscar una Empresa",
            description = "Para usar endPoint debes enviar un id de una Empresa, lo cual se va a buscar en base de datos")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Eliminar una Empresa",
            description = "Para usar endPoint debes enviar un id de una Empresa, lo cual va a cambiar el estado de esta en la base de datos")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> borrarEmpresa(@Parameter(description = "ID de la Empresa a eliminar", required = true) @PathVariable Long id){
    try {
